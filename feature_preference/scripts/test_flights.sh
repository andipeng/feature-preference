...
do
    ...
    do
        ...
        python3 test_reward.py --prefs_type feature_prefs_gt --env flights --reward $reward --test_network train_1 --seed $seed > ../results/flights/$reward/$seed/0results_featureprefsgt.txt
        python3 test_reward.py --prefs_type feature_prefs_gt --env flights --reward $reward --test_network train_3 --seed $seed >> ../results/flights/$reward/$seed/0results_featureprefsgt.txt
        python3 test_reward.py --prefs_type feature_prefs_gt --env flights --reward $reward --test_network train_5 --seed $seed >> ../results/flights/$reward/$seed/0results_featureprefsgt.txt
        python3 test_reward.py --prefs_type feature_prefs_gt --env flights --reward $reward --test_network train_10 --seed $seed >> ../results/flights/$reward/$seed/0results_featureprefsgt.txt
